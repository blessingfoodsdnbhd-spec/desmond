...
export const EyeOffIcon = (p) => (
  <Icon {...p}>
    <path d="M4 4l16 16" />
    <path d="M9.6 5.6A9.6 9.6 0 0 1 12 5.5c6.5 0 10 6.5 10 6.5a15 15 0 0 1-3 3.6M6.3 7.9A15 15 0 0 0 2 12s3.5 6.5 10 6.5a9.7 9.7 0 0 0 3.3-.6" />
    <path d="M9.9 10a3 3 0 0 0 4.1 4.1" />
  </Icon>
)
export const EditIcon = (p) => (
  <Icon {...p}>
    <path d="M13.5 6.5 17 10 8.5 18.5 4.5 19.5 5.5 15.5 14 7z" />
