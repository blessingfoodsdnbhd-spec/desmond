...
const DICT = {
  zh: {
    ...
    'product.order.info': '收货信息',
    'product.order.note': '点「下单购买」后会跳到 WhatsApp 发送订单给我们；确认后我们会发 TNG 给你付款。',
    'admin.entry': '商家后台',
  ...
  en: {
    ...
    'product.order.info': 'Delivery details',
    'product.order.note': 'Tapping “Order” opens WhatsApp with your order. Once confirmed we will send you a TNG request for payment.',
